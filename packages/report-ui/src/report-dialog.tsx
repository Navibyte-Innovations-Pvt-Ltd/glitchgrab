...
interface ReportDialogProps {
   ...
   * the host page). A Chrome extension host should inject
   * `chrome.tabs.captureVisibleTab` here instead — `document.body` in an
   * extension window is the extension's OWN tiny page, not the tab being
   * reported. Return `null` to open without a screenshot.
   */
